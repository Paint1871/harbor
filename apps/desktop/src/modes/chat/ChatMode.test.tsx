...
const chrome: ChromeValue = { mode: "chat", theme: "black", profileName: "Local", destination: "mode", setDestination: () => {}, onModeChange: () => {}, onOpenSession: () => {}, onThemeChange: () => {}, onSettings: () => {}, onTidy: () => {}, registerTidy: () => {}, registerNewThread: () => {}, registerNewAgentChat: () => {}, registerCodeWorkspace: () => {} };
